...
class Question extends React.Component {
  constructor(props) {
    ...
    let audioPathWaiting = "assets/question/audioYona.wav";
    this.audioWaiting = new Audio(audioPathWaiting);
    this.ansAudio = null;
  ...
  componentWillUnmount() {
    ...
    if (!this.audioWaiting.ended) {
      this.audioWaiting.pause();
    }
